...
By the way, in order for the server to work with [PrismarineJS/prismarine-web-client](https://github.com/PrismarineJS/prismarine-web-client), it needs to be in offline mode. This is automatically fixed by the script, but I'm just letting you know.

To begin, create a codespace using this repository and run this command: ```chmod +x start.sh && ./start.sh```.
